...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <link rel="icon" type="image/png" href="http://mochiron.net/favicon.png">
    <head>
            ...
            $( document ).ready(function() {
                ...
                $('span.jpn').each(function(){
                    ...
                    $.get("search.php",
                        ...
                        function( data ) {
                            $this.text(data);
                            $this.html($this.text().split(' ').map(function(x){
                                x = x.split(',');
                                var delim = ' ';
                        ...
                        $this.children().on('tap vclick click',function(){
                            if (!$(this).attr('data-toggled') || $(this).attr('data-toggled') == 'off'){    
                                ...
                                function( data ) {
                                    if (data!=''){
                                        $this.parent().parent()
                                            .append('<div class="tip" id="'+lookup+'">'+data+'</div>')
                                    }   
                                });
    ...
    <body>   
        ...
        <div class="navbar">
            <a href="">
                <span class="pre">mochiron.net </span>
            </a>
            <span class="label">
                by <a href="http://spacedotworks.com">
                    <span class="spd">spacedotworks</span>
                    </a>
            </span> 
        ...
        <?php 
            if (!empty($_GET['key'])){
                ...
                mysqli_query($con,'INSERT INTO shizen_queries (term,date,ip) VALUES ("'.$key.'","'.$dt.'","'.$ip.'")');
